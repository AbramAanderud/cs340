...
export class Dog extends Animal {
  ...
  static getDogsSummary(dogListNotSorted: Dog[]): string {
    let dogList = Animal.getAnimalsSorted(dogListNotSorted);
