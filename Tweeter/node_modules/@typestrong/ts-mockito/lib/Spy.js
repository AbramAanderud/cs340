...
var Spy = (function (_super) {
    ...
    function Spy(instance) {
        var _this = _super.call(this, instance.constructor, instance, true) || this;
    ...
    Spy.prototype.reset = function () {
        ...
        _.forEach(this.realMethods, function (method, key) {
            var _a;
            if (method.instance) {
                Object.defineProperty(_this.instance, key, (_a = method.descriptor) !== null && _a !== void 0 ? _a : {});
            }
            else {
    ...
    Spy.prototype.getEmptyMethodStub = function (key, args) {
        ...
        if (realMethod) {
            var method = ((_a = realMethod.descriptor) === null || _a === void 0 ? void 0 : _a.get) || ((_b = realMethod.descriptor) === null || _b === void 0 ? void 0 : _b.value);
