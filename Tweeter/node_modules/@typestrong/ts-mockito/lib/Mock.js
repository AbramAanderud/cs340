...
var Mocker = (function () {
    function Mocker(clazz, instance, isSpy) {
        if (instance === void 0) { instance = {}; }
        if (isSpy === void 0) { isSpy = false; }
        var _this = this;
        this.clazz = clazz;
        ...
        this.defaultedPropertyNames = ["Symbol(Symbol.toPrimitive)", "then", "catch"];
        ...
        if (typeof Proxy !== "undefined" && this.clazz) {
            ...
            this.instance = new Proxy(this.instance, {
                get: function (target, name) {
                    ...
                    if (!hasMethodStub) {
                        if (_this.defaultedPropertyNames.indexOf(name.toString()) >= 0) {
                            return undefined;
                        }
    ...
    Mocker.prototype.processProperties = function (object) {
        var _this = this;
        ObjectInspector_1.ObjectInspector.getObjectPrototypes(object).forEach(function (obj) {
            ObjectInspector_1.ObjectInspector.getObjectOwnPropertyNames(obj).forEach(function (name) {
    ...
    Mocker.prototype.createActionListener = function (key) {
        ...
        return function () {
            ...
            methodStub === null || methodStub === void 0 ? void 0 : methodStub.execute(args);
            return methodStub === null || methodStub === void 0 ? void 0 : methodStub.getValue();
        };
    };
    ...
    Mocker.prototype.processClassCode = function (clazz) {
        var _this = this;
        var functionNames = this.mockableFunctionsFinder.find(clazz);
