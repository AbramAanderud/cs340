    ...
    <>
      ...
      <div className="text-center mb-3">
        <button
          ...
          onClick={() =>
            displayInfoMessageWithDarkBackground("Google is not implemented.")
          }
        >
          <OverlayTrigger
            placement="top"
        ...
        <button
          ...
          className="btn btn-link btn-floating mx-1"
          onClick={() =>
            displayInfoMessageWithDarkBackground("Facebook is not implemented.")
          }
        >
          <OverlayTrigger
            placement="top"
        ...
        <button
          ...
          className="btn btn-link btn-floating mx-1"
          onClick={() =>
            displayInfoMessageWithDarkBackground("Twitter is not implemented.")
          }
        >
          <OverlayTrigger
            placement="top"
        ...
        <button
          ...
          className="btn btn-link btn-floating mx-1"
          onClick={() =>
            displayInfoMessageWithDarkBackground("LinkedIn is not implemented.")
          }
        >
          <OverlayTrigger
            placement="top"
        ...
        <button
          ...
          className="btn btn-link btn-floating mx-1"
          onClick={() =>
            displayInfoMessageWithDarkBackground("Github is not implemented.")
          }
        >
          <OverlayTrigger
            placement="top"
